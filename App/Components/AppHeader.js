                        ...
                        {title === "Messages" ?
                            <View style={{ backgroundColor: 'white' }} >
                                <View style={{ width: '100%', alignItems: 'center',paddingTop:10 }}>
                                    <Text style={{ fontSize: 25, fontWeight: 'bold', color: '#F9813A' }}>{title}</Text>
                                </View>
                            </View>
                            :
                            <View style={{ flexDirection: 'row', height:60,backgroundColor:'darksalmon' }}>
                                ...
                                <View style={{ width: '100%', alignItems: 'center'}}>
                                    <Text style={{ fontSize: 27, fontWeight: 'bold', color: 'black' }}>{title}</Text>
                                </View>
                            </View>
                        }
