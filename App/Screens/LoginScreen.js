        ...
        return (
            <ScrollView>
                <View style={styles.container} >
                    ...
                    <View style={{ borderTopRightRadius: 30, borderBottomLeftRadius: 30, 
                    borderBottomRightRadius: 30,
                         borderTopLeftRadius: 40, backgroundColor: 'lightblue', margin: 1 }} >
                        <View style={{ left: 20, margin: 20 }}>
                            ...
                            <View style={styles.button}>
                                <TouchableOpacity style={styles.signIn} onPress={() => this.LoginFirebase()}>
                                    <LinearGradient colors={['#1976D2', '#8C9EFF']} style={styles.signIn}  >
                                        <Text style={styles.textSign}> Login </Text>
                                    </LinearGradient>
                                </TouchableOpacity>
                                <View>
                                    <TouchableOpacity onPress={() => { this.props.navigation.navigate('SignUp') }}>
                                        <Text style={{ fontSize: 20, marginTop: 5 }}>New User? Click here.</Text>
                                    </TouchableOpacity>
                                </View>
