            ...
            <ScrollView>
                <View style={styles.container} >
                    ...
                    <View style={{
                        ...
                        borderTopLeftRadius: 40, backgroundColor: '#9FA8DA'
                    }}>
                        <View style={{ left: 20 ,marginTop:20}}>
                            ...
                            <View style={styles.action}>
                                <FontsAw name="envelope-o" color='black' size={16} />
                            ...
                            <View style={styles.button}>
                                <TouchableOpacity style={styles.signIn} onPress={() => this.SignUptoFirebase()}>
                                    <LinearGradient colors={['#2f4f4f', 'lightsteelblue']} style={styles.signIn}  >
